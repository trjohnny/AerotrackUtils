...
class AerotrackApiClientTest {
    ...
    void getBestFlight_Success() throws IOException {
        Flight outboundFlight = new Flight("VCE", "DUB", "2023-01-01T08:00:00.000Z", "2023-01-01T10:00:00.000Z", "Ryanair", 150.0);
        Flight returnFlight = new Flight("DUB", "VCE", "2023-01-10T18:00:00.000Z", "2023-01-10T20:00:00.000Z", "Ryanair", 200.0);
        ...
        assertEquals("Ryanair", result.get(0).getOutboundFlights().get(0).getAirline());
    ...
    void getBestFlight_Failure() throws IOException {
        ...
        Exception exception = assertThrows(RuntimeException.class, () -> aerotrackApiClient.getBestFlight(new ScanQueryRequest()));
